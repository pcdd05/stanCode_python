...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
	...
	if order == 0:
		...
		top_s = GLine(upper_left_x, upper_left_y, upper_left_x + length, upper_left_y)
		left_s = GLine(upper_left_x, upper_left_y, upper_left_x + length * 0.5, upper_left_y + length * 0.866)
		right_s = GLine(upper_left_x + length, upper_left_y, upper_left_x + length * 0.5, upper_left_y + length * 0.866)
		window.add(top_s)
		window.add(left_s)
		window.add(right_s)
